  ...
  return (
    <Section id="home" screen={`h-screen`}>
      <div className="flex items-center justify-center flex-col h-[100%] relative">
        <h1 className="leading-[1.2] px-3 md:leading-[1.5] font-dancingScript text-4xl md:text-6xl font-extrabold bg-gradient-to-r from-cyan-500 to-pink-500 bg-clip-text text-transparent">
